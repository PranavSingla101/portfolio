...
export default function Header() {
  ...
  return (
    <header className="z-[999] relative">
      <motion.div
        className="fixed top-0 left-1/2 h-[4.5rem] w-full rounded-none border border-black/40 bg-gray-950 bg-opacity-75 shadow-lg backdrop-blur-[0.5rem] sm:top-6 sm:h-[3.25rem] sm:w-[42rem] sm:rounded-full"
            ...
            >
              ...
              >
                ...
                {link.name === activeSection && (
                  <motion.span
                    className={clsx(
                      "bg-gray-800 rounded-full absolute -z-10",
                      {
